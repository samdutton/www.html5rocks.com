...
class TutorialForm(forms.Form):
  ...
  url = forms.CharField(label='URL',
      help_text='An abs. or relative url (e.g. /tutorials/feature/something/) - remember the trailing slash!')
  ...
  tags = forms.CharField(
      help_text='Comma separated list (e.g. type:tutorial, indexeddb, class:offline, class:performance, ...)')
